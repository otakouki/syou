...
interface JoJoService3 {
    @GET("LikeInsert.php")
    fun fetchJoJo3(@Query("UUID") UUID: String, @Query("GenreNo") GenreNo: Int): Call<List<JoJo3>>
}
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image5.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image6.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image7.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image8.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image9.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image10.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image11.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image12.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
...
//                            image1.setImageResource(R.drawable.game)
                    ...
                    image13.setOnLongClickListener { // 下側のImageViewのidをimageViewとした例
